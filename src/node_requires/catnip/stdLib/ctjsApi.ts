...
export const loadBlocks = async (): Promise<blockMenu[]> => {
    ...
    const u = filterPatchMenu(menus, allBlocks, 'u.', 'tool', 'Utilities');
    u.items.unshift(...uBlocks);
    u.items.sort((a, b) => sortHelper[a.type] - sortHelper[b.type]);
