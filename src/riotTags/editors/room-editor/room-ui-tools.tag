room-ui-tools
    ...
    script.
        ...
        const {getDefaultAlign} = require('src/lib/resources/rooms');
        ...
        const {copyBindingTypes, getBindingsForBaseClass} = require('src/lib/roomEditor/common');
        this.jsTypeToIcon = {
            string: 'string',
            boolean: 'bool',
        ...
        this.isExpression = val => isExpression(val, {
            strict: true
        });
